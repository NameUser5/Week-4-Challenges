...
#   right_first = alpha[0 : len(alpha)-number]
#   right_second = alpha[len(alpha)-number : ]

#   print(right_second + right_first) 
...
# while ask == True:
#   number = int(input("Enter a positive integer between 0 and 26. "))
